export default function Footer() {
    return (
      <div className="bg-gray-800 dark:bg-gray-900"> {/* Wrapper div */}
  <footer className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-gray-300">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div>
        <h3 className="text-white dark:text-gray-100 font-semibold mb-4">TrendScope</h3>
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm">
          ...
          <li><a href="/privacy" className="hover:text-indigo-400 dark:hover:text-indigo-300 transition-colors">Privacy</a></li>
        </ul>
      </div>
